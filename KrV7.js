...
ambil case kasih credits gw dong 𝙸𝚝'𝚜 𝙼𝚎 𝙱𝙳𝚉
...
ownerNumber = [`${setting.noown}@s.whatsapp.net`]
...
//========================\\
       ...
       const isjasa = isGroup ? _jasa.includes(from) : false   
        ...
        const listmsg = (from, title, desc, list) => { // Fixx
            let po = ALDI.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "Jangan Lupa Follow IG Owner Ya 👍","listType": "SINGLE_SELECT","sections": list}}, {})
...
"body": "",
"previewType": "PHOTO",
"thumbnailUrl": "https://c.top4top.io/p_20757jeb61.png",
"thumbnail": cewe,
"sourceUrl": `https://www.bdzakwan.co`
...
//FUNCTION
    ...
    for (let x of mentionUser) {
                if (afkk.hasOwnProperty(x.split('@')[0])) {
                    ini_mn1k = "Ngapain Kau Tag Dia, Dia Lagi AFK !\n"
                    if (afkk[x.split('@')[0]] != "") {
...
//tempel di src/setting.json nama nya "imgmenu" : "taroh di situ",
    var _0x246a = ["./image/cewe.jpeg", "readFileSync", "prepareMessage", "", "owner", " ᴄᴏɴᴛᴀᴄᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ", "sc", " sc bot", "credits", " credits", "imageMessage", "message", "Follow IG : @Bagasdzkwn_","buttonsMessage","Konichiwa ","Follow Ig Owner Ya KAK :)","PHOTO","./ image / thumb.jpeg","https://bdzakwan.co","sendMessage"];let menq= await ALDI[_0x246a[2]](from,fs[_0x246a[1]](_0x246a[0]),image);gbutsanmm= [{buttonId:`${_0x246a[3]}${prefix}${_0x246a[4]}`,buttonText:{displayText:_0x246a[5]},type:1},{buttonId:`${_0x246a[3]}${prefix}${_0x246a[6]}`,buttonText:{displayText:_0x246a[7]},type:1},{buttonId:`${_0x246a[3]}${prefix}${_0x246a[8]}`,buttonText:{displayText:_0x246a[9]},type:1}];gbuttonanq= {imageMessage:menq[_0x246a[11]][_0x246a[10]],contentText:`${_0x246a[3]}${men1}${_0x246a[3]}`,footerText:_0x246a[12],buttons:gbutsanmm,headerType:4}; await ALDI[_0x246a[19]](from,gbuttonanq,MessageType[_0x246a[13]],{quoted:ftroli,sendEphemeral:true,contextInfo:{forwardingScore:508,isForwarded:true,"\x65\x78\x74\x65\x72\x6E\x61\x6C\x41\x64\x52\x65\x70\x6C\x79":{"\x74\x69\x74\x6C\x65":`${_0x246a[14]}${pushname}${_0x246a[3]}`,"\x62\x6F\x64\x79":_0x246a[15],"\x70\x72\x65\x76\x69\x65\x77\x54\x79\x70\x65":_0x246a[16],"\x74\x68\x75\x6D\x62\x6E\x61\x69\x6C\x55\x72\x6C":`${_0x246a[3]}${imgmenu}${_0x246a[3]}`,"\x74\x68\x75\x6D\x62\x6E\x61\x69\x6C":fs[_0x246a[1]](_0x246a[17]),"\x73\x6F\x75\x72\x63\x65\x55\x72\x6C":_0x246a[18]}}})
...
`
//jangan di hapus nanti eror loh
    var _0x55bd = ["Hallo", "", "\nBy ", "Follow Ig @Bagasdzkwn_", "PHOTO", "https://c.top4top.io/p_20757jeb61.png", "https://www.bdzakwan.co","sendMessage"];ALDI[_0x55bd[7]](from,meu,text,{contextInfo:{text:_0x55bd[0],"\x66\x6F\x72\x77\x61\x72\x64\x69\x6E\x67\x53\x63\x6F\x72\x65":1000000000,isForwarded:false,sendEphemeral:false,"\x65\x78\x74\x65\x72\x6E\x61\x6C\x41\x64\x52\x65\x70\x6C\x79":{"\x74\x69\x74\x6C\x65":`${_0x55bd[1]}${namabot}${_0x55bd[2]}${namaown}${_0x55bd[1]}`,"\x62\x6F\x64\x79":_0x55bd[3],"\x70\x72\x65\x76\x69\x65\x77\x54\x79\x70\x65":_0x55bd[4],"\x74\x68\x75\x6D\x62\x6E\x61\x69\x6C\x55\x72\x6C":_0x55bd[5],"\x74\x68\x75\x6D\x62\x6E\x61\x69\x6C":cewe,"\x73\x6F\x75\x72\x63\x65\x55\x72\x6C":`${_0x55bd[6]}`},mentionedJid:[sender]},quoted:ftroli})
}
} catch {
replyWithFakeLink('eror kak silahkan ketik !setmenu allmenu')
}
break
...
${gaya}👑 ◪• 𝙸𝚝'𝚜 𝙼𝚎 𝙱𝙳𝚉 ⟨ @6285697725326 ⟩${gaya}
...
break
            case 'sc':
            se =`
SC : https://bdzakwan.co/sc-bot [ SCUTO V1 ]
...
if ((args[0]) == 'ngetik'){
			...
			headerType: "IMAGE",
			contentText: "Active!!",
                footerText: '𝙎𝙘𝙪𝙩𝙤 𝘽𝙊𝙏 𝐕1.0.0',
			buttons: buttons,
			headerType: 1
			}
            ALDI.sendMessage(from, buttonMessage, MessageType.buttonsMessage, 
                { contextInfo: { "forwardingScore": 999, "isForwarded": true, 'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `6285697725326@s.whatsapp.net`, 'remoteJid': 'status@broadcast', 'quotedMessage': { "imageMessage": { "caption": `*𝙎𝙘𝙪𝙩𝙤 𝘽𝙊𝙏*\n${gaya}Made By: @Bagasdzkwn_${gaya}`, 'jpegThumbnail': fs.readFileSync('./image/thumb.jpeg')}}}})
   		    break	            
//====[ CASE BC ]===\\
            case 'bc':
...
⏳ Durasi : ${res[0].size}`
            ...
            break
             ...
             sendButMessage(
             from,
             `Prefix Saat ini : ${prefixStatus ? "Multi Prefix" : "No Prefix"}`,
